...
import { UPDATE_ACTIVE_STUDENT_X, UPDATE_ACTIVE_STUDENT_Y, UPDATE_FILTERS, UPDATE_MOD_FILTERS, OPEN_GROUP_FORM, CLOSE_GROUP_FORM, UPDATE_LOADING } from "./constants";
...
export const updateLoading = bool => ({type: UPDATE_LOADING, payload: bool})
